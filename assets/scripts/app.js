...
const scorecard = document.getElementById("scorecard--list");
...
window.onload = function() {
	...
	if(window.location.pathname.indexOf("scorecard") != -1){
		...
		if (radios[i].checked) {
			...
			if (event == "grand-final") {
				...
				if (order == 21) {
					...
					messagebody = "Don't forget; for this digital scorecard, you can vote for every song!\n\nGive every entry between 1 and 12 points.";
				}
